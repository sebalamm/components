...
#ifndef _DYNAMIC_VERTEX_COMMUNICATOR_H_
#define _DYNAMIC_VERTEX_COMMUNICATOR_H_
...
class DynamicVertexCommunicator {
 public:
  DynamicVertexCommunicator(const PEID rank,
                   const PEID size,
  ...
  virtual ~DynamicVertexCommunicator() {};

  DynamicVertexCommunicator(const DynamicVertexCommunicator &rhs) = default;
  DynamicVertexCommunicator(DynamicVertexCommunicator &&rhs) = default;
 
  inline void SetGraph(DynamicGraphCommunicator *g) {
    g_ = g;
  }
