...
// 
  ...
  //   local_edges.set_empty_key(EmptyKey);
  //   local_edges.set_deleted_key(DeleteKey);
  //   google::dense_hash_map<VertexID, std::vector<VertexID>> parent_edges;
  //   parent_edges.set_empty_key(EmptyKey);
  //   parent_edges.set_deleted_key(DeleteKey);
  ...
  //   vertex_messages.set_empty_key(EmptyKey);
  //   vertex_messages.set_deleted_key(DeleteKey);
  ...
  //   high_degree_edge_distribution.set_empty_key(EmptyKey);
  //   high_degree_edge_distribution.set_deleted_key(DeleteKey);

  //   google::dense_hash_set<VertexID> tree_leaf_set;
  //   tree_leaf_set.set_empty_key(EmptyKey);
  //   tree_leaf_set.set_deleted_key(DeleteKey);
  ...
  //   added_local.set_empty_key(EmptyKey);
  //   added_local.set_deleted_key(DeleteKey);
  //   while (converged_globally == 0) {
  //     converged_locally = 1;
  //     for (auto &kv : propagation_buffers) {
  //       VertexID source = kv.first;
  ...
  //   neighboring_pes.set_empty_key(EmptyKey);
  //   neighboring_pes.set_deleted_key(DeleteKey);
  //   g.ForallLocalVertices([&](const VertexID v) {
